...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($cat_name) && !empty($status) && !empty($image)) {
        ...
        $query = "INSERT INTO category (cat_name, image, status) VALUES ('$cat_name', '$image', '$status')";
              ...
              <form method="post">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="image">Image (370x247px)</label>
                            <input type="file" name="image" id="Catimage" class="form-control" accept="image/*" required>
                        </div>
                    </div>
                  </div>
                </div>
...
<script>
  ...
  let myDropzone = new Dropzone("#Catimage", {
      url: '',
      maxFilesize: 3,
      acceptedFiles: 'image/*',
      paramName: 'image',
