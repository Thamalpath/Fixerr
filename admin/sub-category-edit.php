...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Retrieve form data
    $sub_category_id = $_GET['id']; // Assuming you are passing sub category id via URL
    ...
    if ($_FILES['image']['name']) {
        ...
        $sql_select_image = "SELECT image FROM sub_category WHERE id='$sub_category_id'";
        ...
        // Upload new image
        $target_dir = "uploads/sub_category/";
        ...
        // Update sub category data in the database with the new image path
        $sql = "UPDATE sub_category SET sub_cat_name='$sub_cat_name', status='$status', image='$newFilePath' WHERE id='$sub_category_id'";
    } else {
        // Update sub category data in the database without updating the image path
        $sql = "UPDATE sub_category SET sub_cat_name='$sub_cat_name', status='$status' WHERE id='$sub_category_id'";
    }

    // Handle category update
    $category_id = mysqli_real_escape_string($con, $_POST['category_id']);

    // Update sub category data in the database with the new image path and category ID
    $sql = "UPDATE sub_category SET sub_cat_name='$sub_cat_name', status='$status', category_id='$category_id' WHERE id='$sub_category_id'";
    ...
    if ($result) {
        ...
        $_SESSION['error'] = "Error updating sub category: " . mysqli_error($con);
        header("Location: sub-category-edit.php?id=$sub_category_id");
        exit();
    }
}
...
$sql_categories = "SELECT id, cat_name FROM category";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="sub-category.php">Sub Categories</a></li>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cat_name" name="sub_cat_name" value="<?php echo $row['sub_cat_name']; ?>">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control">
                                    <?php foreach ($categories as $category): ?>
                                        <option value="<?php echo $category['id']; ?>" <?php if ($row['category_id'] == $category['id']) echo 'selected'; ?>><?php echo $category['cat_name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
