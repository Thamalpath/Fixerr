...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkEmailQuery = "SELECT * FROM professional WHERE email='$email'";
         ...
         <div class="col-xxl-8 col-xl-8 col-lg-8 mx-auto"> 
            <div class="contact-page-form-area">
               <div class="title-box mb-40 wow fadeInLeft" data-wow-delay=".5s">
                  ...
                  <h3 class="section-title mt-10">Sign Up as a Professional</h3>
               </div>
               <div class="contact-page-form">
                    <form method="post" id="proForm" class="account-form">
