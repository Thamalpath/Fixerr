         ...
         <div class="col-xxl-6 col-xl-6 col-lg-6 mx-auto"> 
            <div class="contact-page-form-area">
                <div class="title-box mb-40 wow fadeInLeft" data-wow-delay=".5s">
                    ...
                    <h3 class="section-title mt-10">Sign Up to Your Account</h3>
                </div>
                <div class="contact-page-form">
                    <div class="row mb-10-none">
                        <div class="col-lg-12 form-group text-center">
                            <a  href="pro-signup.php" class="primary-btn-1 btn-hover w-100">
                                As a Professional &nbsp; | <i class="icon-right-arrow"></i>
                                <span style="top: 147.172px; left: 108.5px;"></span>
                            </a>
                        </div>
                        <div class="col-lg-12 form-group text-center mt-50">
                            <a href="customer-signup.php" class="primary-btn-1 btn-hover w-100">
                                As a Customer  &nbsp; | <i class="icon-right-arrow"></i>
                                <span style="top: 147.172px; left: 108.5px;"></span>
                            </a>
                        </div>
                    </div>
